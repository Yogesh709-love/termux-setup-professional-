...
banner() {
    ...
    echo -e "${R} [!]${W} Youtube : ${W}https://youtube.com/@masti_zone_4?si=nQdaGpPCtlOuoSPp"
    echo -e ""
    echo -e "${G} ==============================================${N}"
    echo -e ""
}
...
menu() {
    banner
    printf "\n${left_pad}${C}[${W}01${C}]${R} YouTube Subscribe"
    printf "\n${left_pad}${C}[${W}02${C}]${G} Necessary Setup"
    printf "\n${left_pad}${C}[${W}03${C}]${G} Zsh Customizer"
    printf "\n${left_pad}${C}[${W}04${C}]${G} Fish Customizer"
    ...
    case $a in
        1|01)
            echo -e "${G}[√] Opening YouTube channel...${RS}"
            termux-open-url "https://youtube.com/@masti_zone_4?si=nQdaGpPCtlOuoSPp"
            sleep 2
            menu
            ;;
        2|02) do_full_setup ;;
